...
//model.setData(donnees);
    ...
    private void initComponents() {
        ...
        jTable_Display_Oeuvres.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jTable_Display_Oeuvres.setColumnSelectionAllowed(true);
        ...
        jTable_Display_Oeuvres.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextField_Commentaire, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton_InsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_InsertActionPerformed
        String query = "INSERT INTO `oeuvre`(`titre`,`date_parution`,`commentaire`,`note`) VALUES ('" + jTextField_Titre.getText() + "','" + jTextField_Annee.getText() + "','" + jTextField_Commentaire.getText() + "','" + jTextField_Note.getText() + "')";
        executeSQlQuery(query, "Inserted");
    }//GEN-LAST:event_jButton_InsertActionPerformed

    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        String query = "UPDATE `oeuvre`SET `titre`= '" + jTextField_Titre.getText() + "', `date_parution`= '" + jTextField_Annee.getText() + "', `commentaire`= '" + jTextField_Commentaire.getText() +"', `note`= '" + jTextField_Note.getText()  + "' WHERE `id`= '" + jTextField_Id.getText() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OeuvreForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
